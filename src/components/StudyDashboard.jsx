...
const STUDY_PLAN = [
  ...
  },
  {
    ...
    desc: 'Przejrzyj ponownie „Ściągę" (teraz powinna być zrozumiała). Rozwiąż Quiz jeszcze raz na czas. Wykonaj krok po kroku symulację stosu i przerwań bez pomocy opisu. Jeśli uzyskasz 80%+ w quizie, jesteś gotowy/a!',
    tab: 'dashboard',
    icon: '🎯',
    color: 'var(--success)',
  },
